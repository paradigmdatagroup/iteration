...
<div class="footer-small"><span>https://github.com/mjfrigaard/pdg</span></div>
...
> "*I need to download multiple files (from separate URLS)*" - [Link to Github repo](https://github.com/mjfrigaard/dds-data)
